...
# 
# # count, diff, norm
# train_df, test_df = aggregation(train_df, test_df, ['TransactionAmt'], cate_cols, agg_types, with_diff=False, with_norm=True)

# cate_cols = ['DT_M', 'DT_W', 'DT_D']
# agg_types = ['count']
# train_df, test_df = aggregation(train_df, test_df, ['TransactionAmt'], cate_cols, agg_types, with_diff=False, with_norm=False)
# 
# for df in [train_df, test_df]:
#     # 当小时账单数在当日账单数的占比
#     # df[ 'H/D_TransactionAmt_cnt'] = df['DT_H_TransactionAmt_count'] / df['DT_D_TransactionAmt_count']
#     # 当日账单数在当周账单数的占比
#     df[ 'D/W_TransactionAmt_count'] = df['DT_D_TransactionAmt_count'] / df['DT_W_TransactionAmt_count']
#     # 当周账单数在当月账单数的占比
#     df[ 'W/M_TransactionAmt_count_'] = df['DT_W_TransactionAmt_count'] / df['DT_M_TransactionAmt_count']
# 
# for df in [train_df, test_df]:
#     del df['DT_D_TransactionAmt_count'],df['DT_W_TransactionAmt_count'],df['DT_M_TransactionAmt_count']
...
cate_cols = ['card1', 'card2', 'card3', 'card5', 'uid1', 'uid2', 'uid3']
agg_types = ['mean', 'std']
