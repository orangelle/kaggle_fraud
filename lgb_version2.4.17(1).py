...
for df in [train_df, test_df]:
    ...
    # card1,2,3,5 + D1-DT
    df['uid2'] = df['card1'].astype(str)+'_'+df['card2'].astype(str)+'_'+df['card3'].astype(str)    +'_'+df['card5'].astype(str)+'_'+df['D15-DT'].astype(str)
    # card1,2,3,5 + addr1,2
    ...
    df['uid5'] = df['card1'].astype(str)+'_'+df['card2'].astype(str)+'_'+df['card3'].astype(str)    +'_'+df['card5'].astype(str)+'_'+df['addr1'].astype(str)+'_'+df['addr2'].astype(str)+'_'+    '_'+df['D15-DT'].astype(str)
