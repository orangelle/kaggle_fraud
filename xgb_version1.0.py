...
def make_predictions_kf(train_df, test_df, feature_cols,cate_cols, labels, param, NFOLDS=2):
    ...
    for i, (train_idx, valid_idx) in enumerate (kf.split(train_values, split_groups)):
        ...
        if LOCAL_TEST:
            ...
            # Training
            bst = xgb.train(param, train_data, num_boost_round=param['n_estimators'], 
                            early_stopping_rounds=lgb_param['early_stopping_rounds'], evals=watchlist, verbose_eval=200)
