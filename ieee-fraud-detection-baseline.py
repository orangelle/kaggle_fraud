...
def make_predictions_groupkfold(tr_df, tt_df, features_columns, target, lgb_params, NFOLDS=2):
...
train_df['uid4'] = train_df['uid2'].astype(str)+'_'+train_df['P_emaildomain'].astype(str)
test_df['uid4'] = test_df['uid2'].astype(str)+'_'+test_df['P_emaildomain'].astype(str)
...
rm_cols = [
    ...
    'uid','uid2','uid3','uid4',      # Our new client uID -> very noisy data
...
for i in tqdm(columns_to_check):
